...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeSurveyEvents = __webpack_require__(9);
	var takeSurveyEvents = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(5);
	var takeSurvey = __webpack_require__(10);
	var api = __webpack_require__(34);
	var ui = __webpack_require__(35);
	//const index = require('../index.js');
	var createPostObject = __webpack_require__(39);

	var onShowMakeSurvey = function onShowMakeSurvey() {
	  $('#make-survey').show();
	  $('#survey-fillout').hide();
	};

	var onCreateTitle = function onCreateTitle(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var surveyInfo = takeSurvey.backDataSurvey();
	...
	var optionCount = 3;
	var onCreateOption = function onCreateOption() {
	  var optionNumber = optionCount.toString();
	...
	var onCreateSurvey = function onCreateSurvey() {
	  var data = createPostObject.getPost();
	  console.log("onCreateSurvey was called");
	  console.log(data);
	  api.createSurvey(data).done(ui.createSurveySuccess).fail(ui.createSurveyFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var surveyApi = __webpack_require__(11);
	//const Handlebars = require('handlebars');

	var dataSurvey = {};

	var completeSurveySuccess = function completeSurveySuccess() {
	  console.log("complete!");
	  var id = $('#single-survey').children('h3').attr('id');
	  var votesListing = __webpack_require__(12);
	  surveyApi.getASurvey(id).done(function (data) {
	    $('#single-survey').html(votesListing(data));
	  }).fail(console.error);
	};

	var completeSurveyFailure = function completeSurveyFailure(error) {
	  console.error(error);
	};

	var getASurveySuccess = function getASurveySuccess(data) {
	  var surveyLength = data.survey.questions.length;
	  $('#take-a-survey').empty();
	  $('#get-every-survey').empty();
	  var ASurveyListing = __webpack_require__(32);
	  $('#take-a-survey').append(ASurveyListing(data));
	  $('#submit-votes').on('click', function () {
	    var arrayObject = {
	      "votesArray": []
	    };
	    var surveyId = $('h3').attr('id');
	    ...
	    surveyApi.sendSurveyVotes(surveyId, arrayObject).done(completeSurveySuccess).fail(completeSurveyFailure);
	  });
	};

	var getASurveyFailure = function getASurveyFailure(error) {
	  console.error(error);
	};

	var getSurveySuccess = function getSurveySuccess(data) {
	  ...
	  $('.btn-warning').on('click', function () {
	    ...
	    console.log(id);
	    surveyApi.getASurvey(id).done(getASurveySuccess).fail(getASurveyFailure);
	  });
	};

	var getSurveyFailure = function getSurveyFailure(error) {
	  console.error(error);
	};
	...
	var deleteSurveyError = function deleteSurveyError(error) {
	  console.error(error);
	};

	var backDataSurvey = function backDataSurvey() {
	  return dataSurvey;
	};

	module.exports = {
	  getSurveySuccess: getSurveySuccess,
	  getSurveyFailure: getSurveyFailure,
	  getASurveySuccess: getASurveySuccess,
	  getASurveyFailure: getASurveyFailure,
	  deleteSurveySuccess: deleteSurveySuccess,
	  deleteSurveyError: deleteSurveyError,
	  completeSurveySuccess: completeSurveySuccess,
	  completeSurveyFailure: completeSurveyFailure,
	  backDataSurvey: backDataSurvey
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getASurvey = function getASurvey(id) {
	...
	var getSurveysAgain = function getSurveysAgain() {
	  return $.ajax({
	...
	var sendSurveyVotes = function sendSurveyVotes(survey_id, data) {
	  return $.ajax({
	...
	module.exports = {
	  getASurvey: getASurvey,
	  getSurveysAgain: getSurveysAgain,
	  sendSurveyVotes: sendSurveyVotes
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "           <p>"
	    + container.escapeExpression(((helper = (helper = helpers.query || (depth0 != null ? depth0.query : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"query","hash":{},"data":data}) : helper)))
	    + "</p>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.answers : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data) {
	    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "              <p> Number of votes for \""
	    + alias4(((helper = (helper = helpers.text || (depth0 != null ? depth0.text : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"text","hash":{},"data":data}) : helper)))
	    + "\": "
	    + alias4(((helper = (helper = helpers.numVotes || (depth0 != null ? depth0.numVotes : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"numVotes","hash":{},"data":data}) : helper)))
	    + "</p>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "       <h3 class=\"survey-title-id\" name=\"survey-title-name\" id=\""
	    ...
	    + " </h3>\n       <div>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.questions : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "       </div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
	  ...
	  return "              <tr><div class=\"radio\">\n                <label>\n                  <input class=\"radio-button\" type=\"radio\" id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\" name=\""
	  ...
	  return " <div class=\"panel-body\">\n    <div class=\"media\">\n      <div class=\"media-body\" id=\"single-survey\">\n        <h3 class=\"survey-title-id\" name=\"survey-title-name\" id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1._id : stack1), depth0))
	    + "\"> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.title : stack1), depth0))
	    + " </h3>\n        <div>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.questions : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</td>\n        </div></tbody>\n      </table>\n        <button class=\"btn btn-success\" id=\"submit-votes\" type=\"submit\" name=\"submit\" value=\"submit\">Submit!</button>\n      </div>\n    </div>\n  </div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"media col-md-4\">\n        <p>hi</p>\n        <button class=\"btn btn-warning\" id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\"> "
	  ...
	  return "<!-- <div class=\"container\">\n  <div class=\"row\">\n"
	    ...
	    + "  </div>\n</div>\n<!-- <div id=\"get-every-survey\">\n<button id=\"123456\" class=\"btn btn-warning\">Take this survey!</button>\n<button id=\"958763\" class=\"btn btn-warning \">No, this one!</button>\n<button class=\"btn btn-warning\">Best Survey here!</button>\n</div> -->\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateSurvey = function updateSurvey(data, survey_id) {
	  return $.ajax({
	    url: app.host + '/surveys/' + survey_id,
	    method: "PATCH",
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var surveys = __webpack_require__(36);
	...
	var createSurveyFailure = function createSurveyFailure(error) {
	  console.error(error);
	};

	var updateSurveySuccess = function updateSurveySuccess() {
	  console.log("success!");
	};

	var updateSurveyFailure = function updateSurveyFailure(error) {
	  console.error(error);
	};
	...
	module.exports = {
	  ...
	  createSurveyFailure: createSurveyFailure,
	  updateSurveySuccess: updateSurveySuccess,
	  updateSurveyFailure: updateSurveyFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetSurveys = function onGetSurveys() {
	  $('#get-every-survey').html('');
	  api.getSurveys().done(ui.getSurveySuccess).fail(ui.getSurveyFailure);
	};
	...
	var showDeleteSurveys = function showDeleteSurveys() {
	  var data = ui.backDataSurvey();
	  var arr = data.surveys;
	  for (var i = 0; i < arr.length; i++) {
	    if (arr[i]._owner === app.user._id) {
	      console.log(arr[i]);
	      var deleteASurveyListing = __webpack_require__(38);
	  ...
	  $('.deleteThis').on('click', function () {
	    var id = this.id;
	    console.log(id);
	    api.deleteSurvey(id).done(ui.deleteSurveySuccess).fail(ui.deleteSurveyError);
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"panel-body\">\n    <div class=\"media\">\n      <div class=\"media-body\">\n        <h3>"
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + " </h3>\n        <button  class=\"btn btn-danger deleteThis\" id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">Delete</button>\n      </div>\n    </div>\n  </div>\n";
	},"useData":true});
